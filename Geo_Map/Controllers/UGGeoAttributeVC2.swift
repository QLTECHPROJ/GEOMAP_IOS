...
//        self.initDatePicker()
    ...
    func buttonEnableDisable(){
        ...
        if !self.txtMapSerialNo.text!.trim.isEmpty && !self.txtName.text!.trim.isEmpty && !self.lblDate.text!.trim.isEmpty && !self.txtMappedBy.text!.trim.isEmpty && !self.txtScale.text!.trim.isEmpty && !self.txtLocation.text!.trim.isEmpty && !self.txtVeinLoad.text!.trim.isEmpty && !self.txtXCordinate.text!.trim.isEmpty && !self.txtYCordinate.text!.trim.isEmpty && !self.txtZCordinate.text!.trim.isEmpty && !self.tvComment.text!.trim.isEmpty{
