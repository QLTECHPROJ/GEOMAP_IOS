...
class OCGeoAttributeVC: ClearNaviagtionBarVC {
    ...
    func configureUI(){
        ...
        self.txtGeologistName.applyStyleFlotingTextfield(placeholderTitle : kGeologistName, fontsize : 14,fontname : .InterSemibol)
        ...
        self.lblSampleCollected.applyLabelStyle(text : kSampleCollected,fontSize : 14,fontName : .InterSemibol)
        self.lblWeathering.applyLabelStyle(text : kWeathering,fontSize : 14,fontName : .InterSemibol)
        self.lblRockStrenght.applyLabelStyle(text : kRockStrength,fontSize : 14,fontName : .InterSemibol)
        self.lblWaterCondition.applyLabelStyle(text : kWaterCondition,fontSize : 14,fontName : .InterSemibol)
        self.lblTypeOfGeologicalStructure.applyLabelStyle(text : kTypeOfGeologicalStructures,fontSize : 14,fontName : .InterSemibol)
        self.lblTypeOfFault.applyLabelStyle(text : kTypeOfFaults,fontSize : 14,fontName : .InterSemibol)
